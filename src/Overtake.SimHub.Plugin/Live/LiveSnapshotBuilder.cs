...
namespace Overtake.SimHub.Plugin.Live
{
    ...
    internal static class LiveSnapshotBuilder
    {
        ...
        {
            // Fonte única: GameLabelResolver (mesma lógica do .otk/LeagueFinalizer). Passa
            // só a sessão atual — o snapshot ao vivo reflete a sessão corrente.
            return GameLabelResolver.DetectGameLabel(new[] { sess });
        }
